    ...
    <div className="main">
        ...
        <div className="areas">
          {[
            ...
            <div className="area" key={area}>
              <div>
                <img src={require("../images/raipur.png")} alt={area} />
              </div>
              <p>{area}</p>
            </div>
          ))}
      ...
      <div className="property">
        ...
        <div className="container-cards">
          <div className="cards lg 3">
            <div className="card-container">
              <div className="image">
                <img src={require("../images/property.png")} alt="image1" />
              </div>
      ...
      <div className="youtube">
        <iframe
          ...
          frameborder="0"
          allowfullscreen
          onClick={() => window.open("https://www.youtube.com/watch?v=vuOJh82TQeU")}
        ></iframe>
      </div>
